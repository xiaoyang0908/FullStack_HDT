...
import { Button, ListItemIcon, ListItemText, MenuList,ListItemButton,Link, Avatar, Box , MenuItem} from '@mui/material';
        ...
        <Drawer variant="permanent" anchor='left' sx={{
            ...
            <Box sx={{ width:"200px",}}>
                    ...
                    {mainListItems.map((v,i)=>(
                        <MenuItem selected={i === selectedIndex} sx={{'.&Mui-selected':{
                            bgcolor:"none"
                        }}}
